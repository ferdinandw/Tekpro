...
class Game(object):
    def __init__(self):
        ...
        self.menu = Menu(("Start","Controls","About","Exit"),font_color = WHITE,font_size=60)
        # Create the player
        self.player = Player(32,128,"v.png")
        ...
        for event in pygame.event.get(): # User did something
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    if self.game_over and not self.controls:
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.controls:
                ...
                self.display_message(screen,"Stand : 147")
            else:
